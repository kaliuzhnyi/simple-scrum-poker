...
public class RetroPasswordCorrectValidator implements ConstraintValidator<RetroPasswordCorrect, Object> {
    ...
    @Override
    public void initialize(RetroPasswordCorrect constraintAnnotation) {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        return Optional.ofNullable(id)
                .map(v -> retroService.passwordCorrect(v, password))
